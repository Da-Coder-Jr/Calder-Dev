...
// Import the next-themes package
...
export function ThemeToggle({ className }: ThemeToggleProps) {
  // We'll use this state for hydration safety
  ...
  // If not mounted yet, render same dimensions but without content to avoid layout shift
  if (!mounted) {
